...
static inline jlong wrapped_Java_com_badlogic_gdx_physics_box2d_World_jniCreateConstantVolumeJoint
(JNIEnv* env, jobject object, jlong addr, jlongArray obj_bodies, jint numberOfBodies, long long* bodies) {
...
JNIEXPORT jlong JNICALL Java_com_badlogic_gdx_physics_box2d_World_jniCreateConstantVolumeJoint(JNIEnv* env, jobject object, jlong addr, jlongArray obj_bodies, jint numberOfBodies) {
	long long* bodies = (long long*)env->GetPrimitiveArrayCritical(obj_bodies, 0);

	jlong JNI_returnValue = wrapped_Java_com_badlogic_gdx_physics_box2d_World_jniCreateConstantVolumeJoint(env, object, addr, obj_bodies, numberOfBodies, bodies);

	env->ReleasePrimitiveArrayCritical(obj_bodies, bodies, 0);
